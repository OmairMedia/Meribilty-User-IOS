...
import 'package:meribiltyapp/screens/pro/pro_drawer.dart';
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color: Colors.white,
                                border: Border.all(
                                    color: Constants.Primary, width: 3),
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/car-motorbike-care/");
                        },
                        child: Container(
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/tyres-wheels/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/drum-assembly-brakes/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/oils-fluids/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/replacement-parts/shock-suspension/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/exterior/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
                      ...
                      InkWell(
                        onTap: () {
                          launchURL("https://gurukart.pk/product-category/engine/");
                        },
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          height: 200,
