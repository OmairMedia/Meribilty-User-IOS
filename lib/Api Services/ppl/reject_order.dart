...
Future rejectOrder(String orderNo) async {
  var headers = {'Content-Type': 'application/json'};
  Uri apiurl = Uri.parse('https://staging-api.meribilty.com/ppl/order_reject_2');
  var response = await http.Client().post(apiurl,
      headers: headers,
      body: json.encode({"token": box.read('token'), "orderNo": orderNo}));
