...
class UpcountryOrderCard extends StatefulWidget {
  final String status;
  const UpcountryOrderCard({Key? key, required this.status}) : super(key: key);

  @override
  _UpcountryOrderCardState createState() => _UpcountryOrderCardState();
}

class _UpcountryOrderCardState extends State<UpcountryOrderCard> {
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      FittedBox(
                        ...
                        vehicleType,
                        style:
                            Constants.heading2.copyWith(color: Constants.White),
                      )),
                      FittedBox(
                          child: Text(
                        "$weight $material",
