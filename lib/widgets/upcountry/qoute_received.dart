...
class UpcountryOfferReceivedCard extends StatefulWidget {
  final String status;
  const UpcountryOfferReceivedCard({Key? key, required this.status})
      : super(key: key);

  @override
  _UpcountryOfferReceivedCardState createState() =>
      _UpcountryOfferReceivedCardState();
}

class _UpcountryOfferReceivedCardState extends State<UpcountryOfferReceivedCard> {
  @override
